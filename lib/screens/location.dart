...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading // Use isLoading to show a loading indicator
  ...
  void updateLocation(l.LocationData data) async {
    ...
    setState(() {
      ...
      isLoading = false; // Set isLoading to false when location is updated
    });
  ...
  Future<void> loadLastKnownLocation() async {
    ...
    setState(() {
      isLoading =
          false; // Set isLoading to false when last known location is loaded
    });
  }
}
